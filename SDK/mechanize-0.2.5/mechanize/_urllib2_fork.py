...
class HTTPRedirectHandler(BaseHandler):
    ...
    def _default_redirect_callback():
        pass
    
    _redirect_callback = _default_redirect_callback
    
    def __init__(self, callback = None):
        if not callback is None:
            self.set_redirect_callback(callback)
    
    def set_redirect_callback(self, callback):
    ...
    def redirect_request(self, req, fp, code, msg, headers, newurl):
        ...
        if (code in (301, 302, 303, 307, "refresh") and m in ("GET", "HEAD")
            ...
            self._redirect_callback(req, code, newurl)
